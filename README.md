...
This repository keeps a real daily record of LeetCode practice: Python3 solutions, Chinese notes, and daily logs.
...
| 12 | Integer to Roman | Medium | [solution.py](leetcode/0012-integer-to-roman/solution.py) | [notes.md](leetcode/0012-integer-to-roman/notes.md) |
...
| 69 | Sqrt(x) | Easy | [solution.py](leetcode/0069-sqrtx/solution.py) | [notes.md](leetcode/0069-sqrtx/notes.md) |
...
| 71 | Simplify Path | Medium | [solution.py](leetcode/0071-simplify-path/solution.py) | [notes.md](leetcode/0071-simplify-path/notes.md) |
...
| 123 | Best Time to Buy and Sell Stock III | Hard | [solution.py](leetcode/0123-best-time-to-buy-and-sell-stock-iii/solution.py) | [notes.md](leetcode/0123-best-time-to-buy-and-sell-stock-iii/notes.md) |
...
| 127 | Word Ladder | Hard | [solution.py](leetcode/0127-word-ladder/solution.py) | [notes.md](leetcode/0127-word-ladder/notes.md) |
...
| 149 | Max Points on a Line | Hard | [solution.py](leetcode/0149-max-points-on-a-line/solution.py) | [notes.md](leetcode/0149-max-points-on-a-line/notes.md) |
| 150 | Evaluate Reverse Polish Notation | Medium | [solution.py](leetcode/0150-evaluate-reverse-polish-notation/solution.py) | [notes.md](leetcode/0150-evaluate-reverse-polish-notation/notes.md) |
...
| 191 | Number of 1 Bits | Easy | [solution.py](leetcode/0191-number-of-1-bits/solution.py) | [notes.md](leetcode/0191-number-of-1-bits/notes.md) |
...
| 918 | Maximum Sum Circular Subarray | Medium | [solution.py](leetcode/0918-maximum-sum-circular-subarray/solution.py) | [notes.md](leetcode/0918-maximum-sum-circular-subarray/notes.md) |
...
1. Choose the next unsolved problems from LeetCode Top 100 Liked, sorted by difficulty from Easy to Medium to Hard.
2. Save each Python3 solution under `leetcode/<number>-<slug>/solution.py`.
3. Save the Chinese explanation under `leetcode/<number>-<slug>/notes.md`.
4. Update `logs/YYYY-MM-DD.md` with accepted submissions and links.
5. Update this `README.md` so the repository index stays current.
6. Commit and push only real accepted work.
